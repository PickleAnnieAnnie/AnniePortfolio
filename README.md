...
[![GitHub license](https://img.shields.io/github/license/lohit /Portfolio?style=flat-square)](LICENSE)
...
```bash
git clone https://github.com/lohit/Portfolio-Website
```
